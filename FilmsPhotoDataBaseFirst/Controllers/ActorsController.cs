...
namespace FilmsPhotoDataBaseFirst.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,LastName,Photo,PhotoType")] Actor actor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,LastName,Photo,PhotoType")] Actor actor)
        {
            if (ModelState.IsValid)
            {
